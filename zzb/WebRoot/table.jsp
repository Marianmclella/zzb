				...
				<form class="am-form">
					<table class="am-table am-table-striped am-table-hover table-main">
						...
						<tbody>
							...
							%>
							<tr>
								<td><input id="<%=news.getId()%>" type="checkbox">
								</td>
								<td><%=news.getId() %></td>
								<td><a href="#"><%=news.getTitle()%></a>
								</td>
								<td><%=news.getType()%></td>
								...
								<td>
									<div class="am-btn-toolbar">
										<div class="am-btn-group am-btn-group-xs">
											<input type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" 
											value="编辑" name="<%=news.getId() %>" style="width: 60px" onclick="edit(this.name)" />
											
											<input type="button" class="am-btn am-btn-danger am-btn-xs " 
											value="删除" name="<%=news.getId() %>" style="width: 60px" onclick="del(this.name)" />
